  ...
  return (
    <div className={classes.background}>
      ...
      <Container maxWidth='md' className={classes.cont}>
        ...
        <p>Please note that the hours may change for any reason at any time.</p>
        ...
        <a>
          <i>
            *If you are on the outdoor facilities during off-hours, police may
            be called and you will be subjected to arrest.
            <br />
